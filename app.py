...
def create_user():
    ...
    #condição para inserir os dados no banco de dados e criptografando a senha cadastrada no login
    if username and password:
        hashed_password = bcrypt.hash.pw(str.encode(password), bcrypt.gensalt())
